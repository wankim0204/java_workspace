...
public class CalendarApp extends Application{
	...
	public void getStartDayOfWeek() {
		...
		System.out.println("조작된 월의 시작 요일은: "+startDayOfWeek);//조작된 상태의 날짜 객체에게 현재 요일을 물어보자
	}
	...
	public void printData() {
		...
		//주의!!! 출력하기 전에, 유저가 선택한 년,월을 이용하여 startDayOfWeek, lastDate를 다시 구해야 함
		//따라서 아래의 메서드를 다시 호출하면 됨..
		getStartDayOfWeek();
		getLastDate();
