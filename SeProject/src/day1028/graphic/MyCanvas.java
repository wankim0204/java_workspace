...
public class MyCanvas extends Canvas{
	Toolkit kit; //플랫폼(os 종류 win ,mac , linux)에 따라 알맞게 자원을 가져올 수 있도록 해주는 객체
	Image img;//얘도 추상임.. 근데 툴킷을 통해 인스턴스를 얻을 수 있음..
	...
	public void paint(Graphics g) {
		//매개변수인 Graphics  객체는 현실에서의 팔레트와 비유할 수있지만, 단지 색상만 관여하는 것이 아니라
		//도형, 텍스트, 이미지 , 선, 점 등 다양한 그래픽 처리를 위한 기능을 지원하는 실질적 그래픽 처리 담당자이다
		...
		//            일반,추상,인터페이스
		//조사해보니, 이미지는 추상클래스다!! 
		//실망X : 추상클래스인 경우, 개발자가 자식클래스로 구현후,자식을 new 해서 사용해야 함이 원칙이지만,
